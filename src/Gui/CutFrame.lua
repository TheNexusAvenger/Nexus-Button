...
function CutFrame:__InitializeEvents()
    ...
    self:AddPropertyFinalizer("BackgroundColor3",function()
        self.object:__UpdateVisibleFrames()
    end)
    self:AddPropertyFinalizer("BackgroundTransparency",function()
        self.object:__UpdateVisibleFrames()
    end)
    self:AddPropertyFinalizer("ZIndex",function()
        self.object:__UpdateVisibleFrames()
    end)
    self:AddPropertyFinalizer("CutPoints",function()
        self:__CutPointsUpdated()
    end)
